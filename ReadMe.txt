...
Live version as of 16th Jan 2017.
...
server_relay.py   is the server that relays packets for the in-game LAN (network) server lobby list. Now obsolete, use cache version!
